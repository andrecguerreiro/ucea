...
def topology_converter_mine(roof_prediction, osm_building):
    ...
    def internal_function(matched_code,parsed,data,theta,corners,intersections,base_height,parts):
...
def use_this_function(
            ...
            matched_data.append(
                {
                    ...
                    "osm_id": building_id,  # compatibility with existing map layers/tooltips
                    "footprint": outline,
    ...
    print("Map saved successfully to: building_map.html")
